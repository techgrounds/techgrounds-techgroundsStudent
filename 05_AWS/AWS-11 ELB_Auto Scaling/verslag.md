...
### Resultaat
We beginnen allereerst met het lanceren van een instance met de specificaties genoemd in de opdracht: ![](/00_includes/05_AWS/Capture_ontsta_retáblissement.PNG) Deze instance heet dus rétablissement. Via het dasboard kunnen we deze instance selecteren. Na deze selectie geven we de AWS-console de opdracht er een AMI van te maken:![](/00_includes/05_AWS/Capture_creation_IMAGE.PNG)  
